...
| `internal/sync/summary_keys.go`, `internal/sync/failure_messages.go`, `internal/sync/issue_types.go`, `internal/sync/enums.go`, `internal/sync/core_types.go`, `internal/sync/store_types.go`, `internal/sync/worker_result.go`, `internal/sync/actions.go` | `spec/design/error-model.md` | `spec/design/sync-store.md`, `spec/design/sync-engine.md` |
