...
| `internal/sync/engine*.go`, `internal/sync/engine_runtime_prepare*.go`, `internal/sync/engine_current_observe.go`, `internal/sync/watch_*.go`, `internal/sync/permissions.go`, `internal/sync/permission_*.go`, `internal/cli/sync_flow.go`, `internal/cli/sync_runtime.go`, `internal/cli/sync_render.go` | `spec/design/sync-engine.md` | |
