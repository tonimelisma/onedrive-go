...
| `internal/sync/engine*.go`, `internal/sync/engine_current_*.go`, `internal/sync/engine_runtime_*.go`, `internal/sync/engine_watch_*.go`, `internal/sync/permissions.go`, `internal/sync/permission_*.go`, `internal/cli/sync_flow.go`, `internal/cli/sync_runtime.go`, `internal/cli/sync_render.go` | `spec/design/sync-engine.md` | |
