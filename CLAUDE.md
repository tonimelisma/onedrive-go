...
**Phases 1-3.5 complete. Phase 4v2 Increments 0-5 complete. Next: 4v2.6-4v2.8.** All development on `clean-slate` branch (`main` is read-only safety net). See [docs/roadmap.md](docs/roadmap.md).
...
- **`internal/sync/`** — Event-driven sync: types, baseline, observers, buffer, planner — 91.2% coverage
