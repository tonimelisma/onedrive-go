...
func TestClassifyResult_RemoteRetriesAndSkips(t *testing.T) {
	...
	assertClassifyResultCases(t, []classifyResultCase{
		...
		{name: "400_outage_message_wrong_code", result: synctypes.WorkerResult{HTTPStatus: http.StatusBadRequest, Err: wrongCodeOutageErr}, wantClass: resultSkip, wantRecordMode: recordFailureActionable},
