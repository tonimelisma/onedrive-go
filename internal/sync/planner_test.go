...
func TestClassifyFolder_RemoteDeletedFolderOutcomes(t *testing.T) {
	tests := []struct {
		...
		{name: "ED6_RemoteDeletedFolder", localType: synctypes.ChangeModify, wantType: ActionLocalDelete},
		{name: "ED7_BothGone", localType: synctypes.ChangeDelete, wantType: ActionCleanup},
	}
...
func TestDetectLocalChange(t *testing.T) {
	...
	view = &PathView{
		Baseline: &BaselineEntry{ItemType: synctypes.ItemTypeFile, LocalHash: "h1"},
	}
	...
	view = &PathView{
		...
		Local:    &LocalState{ItemType: synctypes.ItemTypeFolder},
	}
...
func TestDetectRemoteChange(t *testing.T) {
	...
	view = &PathView{
		Baseline: &BaselineEntry{ItemType: synctypes.ItemTypeFile, RemoteHash: "h1"},
	}
...
func TestPlan_DeterministicOrder(t *testing.T) {
	...
	changes := []PathChanges{
		{Path: "z/delta.txt", LocalEvents: []ChangeEvent{{Source: synctypes.SourceLocal, Type: synctypes.ChangeCreate, Path: "z/delta.txt", ItemType: synctypes.ItemTypeFile, Hash: "h4"}}},
		{Path: "a/alpha.txt", LocalEvents: []ChangeEvent{{Source: synctypes.SourceLocal, Type: synctypes.ChangeCreate, Path: "a/alpha.txt", ItemType: synctypes.ItemTypeFile, Hash: "h1"}}},
		{Path: "m/beta.txt", LocalEvents: []ChangeEvent{{Source: synctypes.SourceLocal, Type: synctypes.ChangeCreate, Path: "m/beta.txt", ItemType: synctypes.ItemTypeFile, Hash: "h2"}}},
		{Path: "b/gamma.txt", LocalEvents: []ChangeEvent{{Source: synctypes.SourceLocal, Type: synctypes.ChangeCreate, Path: "b/gamma.txt", ItemType: synctypes.ItemTypeFile, Hash: "h3"}}},
	}
...
func TestPlan_DeniedPrefix_SuppressesUploads(t *testing.T) {
	...
	changes := []PathChanges{{
		...
		LocalEvents:  []ChangeEvent{{Type: synctypes.ChangeModify, Path: "Shared/ReadOnly/file.txt", ItemType: synctypes.ItemTypeFile, Hash: "bbb"}},
		RemoteEvents: nil,
	}}
...
func TestPlan_DeniedPrefix_OutsideDenied_Normal(t *testing.T) {
	...
	changes := []PathChanges{{
		...
		LocalEvents:  []ChangeEvent{{Type: synctypes.ChangeModify, Path: "Writable/file.txt", ItemType: synctypes.ItemTypeFile, Hash: "bbb"}},
		RemoteEvents: nil,
	}}
