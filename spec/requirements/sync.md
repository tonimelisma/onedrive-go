...
- R-2.10.9: When `recheckPermissions()` discovers a previously-denied folder is now writable, the system shall clear the block scope and release all blocked actions under that folder immediately. [verified]
- R-2.10.10: When the scanner observes a previously-blocked file or directory is now accessible, the system shall clear the blocking condition and release blocked actions. [verified]
