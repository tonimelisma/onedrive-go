...
- R-2.10.32: The `status` command shall show per-scope block status as separate entries per drive, preserving separate condition groups even when the summary key is the same. [designed]
