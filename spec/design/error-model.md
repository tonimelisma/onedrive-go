...
| Read-only/persistent store projection of classified failures | `internal/syncstore/inspector_test.go` (`TestInspector_ReadVisibleIssueSnapshot`, `TestInspector_ReadStatusSnapshot_IssueSummary`, `TestInspector_ReadStatusSnapshot_StaysConsistentWithVisibleIssueSnapshot`), `internal/cli/status_test.go` (`TestQuerySyncState_WithMetadata`, `TestQuerySyncState_PendingSyncAndIssues`, `TestQuerySyncState_CountsAuthAndRemoteBlockedScopesAsIssues`, `TestQuerySyncState_UsesReadOnlyProjectionHelper`) |
