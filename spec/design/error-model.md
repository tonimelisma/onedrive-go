...
| Shared summary-key normalization and CLI rendering tables | `internal/sync/summary_keys_test.go`, `internal/cli/status_test.go`, `internal/cli/status_golden_test.go` |
| Sync result classification foundations | `internal/sync/engine_result_scope_test.go` |
