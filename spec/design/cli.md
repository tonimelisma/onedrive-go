...
- `internal/cli` unit test coverage target: 60%+ (currently mid-50s). The service split and output-writer injection are in place, but more direct `RunE`/service black-box coverage is still needed to reach the target. [planned]
