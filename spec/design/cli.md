...
- Informational commands (`drive list`, `status`, `whoami`) do not require a fully valid config. Future work (R-4.8.4) will switch them to lenient config loading that collects validation errors as warnings instead of failing. [planned]
