...
| Watch shutdown enters drain before accepting cancellation-closed intake channels as terminal, so retry and trial timers stop at the observable shutdown boundary. | `TestWatchRuntime_RunNonDrainingWatchStep_CanceledClosedReplanStartsDrain`, `TestRunWatch_ShutdownStopsRetryAndTrialTimers` |
