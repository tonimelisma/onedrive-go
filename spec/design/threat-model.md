...
| Durable state authority and crash recovery | `internal/syncstore/store_recover_test.go` (`TestRecoverSyncStore_RepairsReadableStoreInPlace`, `TestRecoverSyncStore_RebuildPreservesDurableIntent`), `internal/sync/engine_run_once_test.go` (`TestRunOnce_ReconcilesRemoteMirrorDownloadDriftWithoutFreshDelta`, `TestRunOnce_ReconcilesRemoteDeleteDriftWithoutFreshDelta`), `internal/sync/engine_phase0_test.go` (`TestBootstrapSync_ReconcilesRemoteDeleteDriftWithoutFreshDelta`) |
