...
- in one-shot mode, each configured parent runs as an ordinary engine and
  ...
  with its final accepted child work snapshot. No parent waits for unrelated
