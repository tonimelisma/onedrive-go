...
shortcuts inside one parent remain parent-engine topology state.
...
- publication is structurally split into `RunnerWork.Children` and
  ...
  request rather than inferred topology absence
