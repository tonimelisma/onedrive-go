...
| W4 | done | done | partial | n/a | done | partial | partial | partial | durable row-mutation and crash-recovery contracts remain the highest-risk gap now that status/verify output semantics are reconciled |
