...
| `engine.go`, `engine_config.go`, `engine_run_once*.go`, `engine_watch*.go` | Runtime orchestration: one-shot results, watch bootstrap, watch loop/drain ownership, and steady-state replan flow |
