...
| `engine_runtime_invariants.go`, `engine_runtime_scopes.go`, `engine_runtime_admission.go`, `scope_lifecycle_policy.go` | Runtime scope lifecycle: startup cleanup, timed blocker activation, release/discard, admission, and shared lifecycle policy for retry/write scopes |
