# Archived Increment Metrics — Phases 1-4

Detailed per-increment metrics from Phases 1 through 4. The active metrics file (`docs/metrics.md`) contains only the trend summary and current/next increment.
